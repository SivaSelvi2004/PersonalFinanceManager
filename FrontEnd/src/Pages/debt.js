    ...
    return(
       ...
       <div className="dd2">
        ...
        <div className='dd6'>
                ...
                <Link to='/lend'><Button className='button'variant='contained' style={{color:'white'}}state={{ data }}> Lend </Button></Link>
                </div>

                <div className='dd8'>
                <Link to='/borrow'><Button className='button'variant='contained' style={{color:'white'}} state={{ data }}> Borrow </Button></Link>

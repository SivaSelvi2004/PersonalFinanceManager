        ...
        <body>
          <div className="hd1">
            <div className='hd'>
              ...
              <ul id="navbar1" >
              <li>
                  <Link to="/dashboard"  class="nav-link" state={{ename:en}}><h3>DashBoard</h3></Link>
                </li><br></br><br></br>
            
              <li>
                  <Link to="/income" class="nav-link" state={{enam:en}}><h3>Income</h3></Link>
                </li><br></br><br></br>
                <li>
                  <Link to="/expense" class="nav-link" state={{ena:en}}><h3>Expense</h3></Link>
                </li><br></br><br></br>
                <li>
                  <Link to="/budget" class="nav-link" state={{sname:en}}><h3>Budget</h3></Link>
                </li><br></br><br></br>
                <li>
                  <Link to="/goal" class="nav-link" state={{ename:en}}><h3>Goals</h3></Link>
                </li><br></br><br></br>
                <li>
                  <Link to="/debt" class="nav-link" state={{ename:en}}><h3>Debt</h3></Link>
                </li><br></br><br></br>
                </ul>
              </div>
            </div>
